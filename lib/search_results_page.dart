              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  if ((selectedCategories
                              .isEmpty || // Keine Kategorie ausgewählt
                    ...
                    // if (widget.locations[index]['displayName']
                    //         .toLowerCase()
                    //         .contains(searchController.text.toLowerCase()) ||
                    //     (widget.locations[index]['categories'] as List<dynamic>)
                    //         .map((e) => e.toString())
                    //         .toList()
                    //         .any((category) =>
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Positioned(
                                    ...
                                    child: Row(
                                      children: [
                                        ...getCategoryImages(appData.categories,
